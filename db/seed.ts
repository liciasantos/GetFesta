...
async function main() {
  ...
  for (const [estado, nome, macrorregiao] of [
    ...
    ["MG", "Contagem", "Minas Gerais"],
    ["MG", "Betim", "Minas Gerais"],
    ["MG", "Montes Claros", "Minas Gerais"],
    ["MG", "Uberaba", "Minas Gerais"],
    ["MG", "Governador Valadares", "Minas Gerais"],
    ["MG", "Ipatinga", "Minas Gerais"],
    ["MG", "Sete Lagoas", "Minas Gerais"],
    ["MG", "Divinópolis", "Minas Gerais"],
    ["MG", "Poços de Caldas", "Minas Gerais"],
    ["MG", "Patos de Minas", "Minas Gerais"],
    // Santa Catarina
    ["SC", "Florianópolis", "Santa Catarina"],
    ["SC", "Joinville", "Santa Catarina"],
    ["SC", "Blumenau", "Santa Catarina"],
    ["SC", "São José", "Santa Catarina"],
    ["SC", "Chapecó", "Santa Catarina"],
    ["SC", "Itajaí", "Santa Catarina"],
    ["SC", "Criciúma", "Santa Catarina"],
    ["SC", "Jaraguá do Sul", "Santa Catarina"],
    ["SC", "Lages", "Santa Catarina"],
    ["SC", "Balneário Camboriú", "Santa Catarina"],
    ["SC", "Palhoça", "Santa Catarina"],
    // Pernambuco
    ["PE", "Recife", "Pernambuco"],
    ["PE", "Jaboatão dos Guararapes", "Pernambuco"],
    ["PE", "Olinda", "Pernambuco"],
    ["PE", "Caruaru", "Pernambuco"],
    ["PE", "Petrolina", "Pernambuco"],
    ["PE", "Paulista", "Pernambuco"],
    ["PE", "Cabo de Santo Agostinho", "Pernambuco"],
    ["PE", "Camaragibe", "Pernambuco"],
    ["PE", "Garanhuns", "Pernambuco"],
    ["PE", "Vitória de Santo Antão", "Pernambuco"],
    ["PE", "Igarassu", "Pernambuco"],
    // Bahia
    ["BA", "Salvador", "Bahia"],
    ["BA", "Feira de Santana", "Bahia"],
    ["BA", "Vitória da Conquista", "Bahia"],
    ["BA", "Camaçari", "Bahia"],
    ["BA", "Itabuna", "Bahia"],
    ["BA", "Juazeiro", "Bahia"],
    ["BA", "Ilhéus", "Bahia"],
    ["BA", "Lauro de Freitas", "Bahia"],
    ["BA", "Porto Seguro", "Bahia"],
    ["BA", "Barreiras", "Bahia"],
    ["BA", "Jequié", "Bahia"],
    // Rio Grande do Sul
    ["RS", "Porto Alegre", "Rio Grande do Sul"],
    ["RS", "Caxias do Sul", "Rio Grande do Sul"],
    ["RS", "Pelotas", "Rio Grande do Sul"],
    ["RS", "Canoas", "Rio Grande do Sul"],
    ["RS", "Santa Maria", "Rio Grande do Sul"],
    ["RS", "Gravataí", "Rio Grande do Sul"],
    ["RS", "Viamão", "Rio Grande do Sul"],
    ["RS", "Novo Hamburgo", "Rio Grande do Sul"],
    ["RS", "São Leopoldo", "Rio Grande do Sul"],
    ["RS", "Passo Fundo", "Rio Grande do Sul"],
    ["RS", "Bento Gonçalves", "Rio Grande do Sul"],
    // Paraná
    ["PR", "Curitiba", "Paraná"],
    ["PR", "Londrina", "Paraná"],
    ["PR", "Maringá", "Paraná"],
    ["PR", "Ponta Grossa", "Paraná"],
    ["PR", "Cascavel", "Paraná"],
    ["PR", "São José dos Pinhais", "Paraná"],
    ["PR", "Foz do Iguaçu", "Paraná"],
    ["PR", "Colombo", "Paraná"],
    ["PR", "Guarapuava", "Paraná"],
    ["PR", "Paranaguá", "Paraná"],
    ["PR", "Toledo", "Paraná"],
    // Distrito Federal - regioes administrativas tratadas como "cidade" pra
    // fins de area de atuacao (DF nao tem municipios de verdade)
    ["DF", "Brasília", "Distrito Federal"],
    ["DF", "Taguatinga", "Distrito Federal"],
    ["DF", "Ceilândia", "Distrito Federal"],
    ["DF", "Águas Claras", "Distrito Federal"],
    ["DF", "Guará", "Distrito Federal"],
    ["DF", "Samambaia", "Distrito Federal"],
    ["DF", "Planaltina", "Distrito Federal"],
    ["DF", "Gama", "Distrito Federal"],
    ["DF", "Sobradinho", "Distrito Federal"],
    ["DF", "São Sebastião", "Distrito Federal"],
    ["DF", "Recanto das Emas", "Distrito Federal"],
  ]) {
